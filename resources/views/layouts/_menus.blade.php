<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul class="mt-6">
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.forms') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.cards') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.charts') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.buttons') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.modals') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.tables') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.calendar') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
